...
function MessageSection() {
	useGSAP(() => {
		...
		const secondMessage = SplitText.create(".second-message", { type: "words" });
		const paragraphMessage = SplitText.create(".message-content p", { type: "words", linesClass: "paragraph-line" });
